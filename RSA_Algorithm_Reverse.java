...
class Encryption {
    ...
    double cipherText;
    double n;
    Encryption(double privateKey, double plainText, double n) {
...
class Decryption {
    ...
    double plainText;
    double n;
    Decryption(double publicKey, double cipherText, double n) {
        System.out.println("\nSignature Text to be decrypted : "+ (long)cipherText);
...
public class RSA_Algorithm_Reverse {
    double public_key;
    ...
    public static void main(String[] args) {
        ...
        RSA_Algorithm_Reverse rsa_algorithm = new RSA_Algorithm_Reverse();
        double p,q,massage;
        String query;
        ...
        System.out.println("Signature Text : " + (long)cipherText);
